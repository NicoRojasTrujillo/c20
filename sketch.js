...
function createCash() {
  if (World.frameCount % 200 == 0) {
    ...
    var cash = createSprite(Math.round(random(50, 1200), 40, 10, 10))
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(Math.round(random(50, 1200), 40, 10, 10));
...
function createSword() {
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(Math.round(random(50, 1200), 40, 10, 10));
